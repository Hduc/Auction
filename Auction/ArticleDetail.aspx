<%@ Page Title="" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="ArticleDetail.aspx.cs" Inherits="Auction_ArticleList" %>
                                    ...
                                    <div role="main" id="content">
                                        <article class="blog_entry">
                                            ...
                                            <div class="entry-content">
                                                <div class="featured-thumb"><a href="#"><img alt="blog-img5" src="images/blog-lg-img.jpg"></a></div>
                                                    ...
                                                    <li class="comment">
                                                        <div class="comment-wrapper">
                                                            <div class="comment-author vcard">
                                                                <p class="gravatar"><a href="#"><img width="60" height="60" alt="avatar" src="images/avatar60x60.jpg"></a></p>
