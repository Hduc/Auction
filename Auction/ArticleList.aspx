<%@ Page Title="" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="ArticleList.aspx.cs" Inherits="Auction_ArticleList" %>
                                    ...
                                    <div role="main" id="content">
                                        <article class="blog_entry">
                                            <div class="entry-content">
                                                <div class="featured-thumb"><a href="blog_single_post.html"><img alt="blog-img5" src="images/blog-lg-img.jpg"></a></div>
                                                ...
                                                <a class="btn" href="blog_single_post.html">Read More</a>
                                            </div>
                                        </article>
                                        <article class="blog_entry">
                                            <div class="entry-content">
                                                <div class="featured-thumb"><a href="blog_single_post.html"><img alt="blog-img2" src="images/blog-lg-img1.jpg"></a></div>
                                                <header class="blog_entry-header">
                                                    <div class="blog_entry-header-inner">
                                        ...
                                        <article class="blog_entry">
                                            <div class="entry-content">
                                                <div class="featured-thumb"><a href="blog_single_post.html"><img alt="blog-img1" src="images/blog-lg-img2.jpg"></a></div>
                                                <header class="blog_entry-header">
                                                    <div class="blog_entry-header-inner">
                            ...
                            <div class="popular-posts widget widget__sidebar" id="recent-posts-4">
                                ...
                                <div class="widget-content">
                                    <ul class="posts-list unstyled">
                                        <li>
                                            <figure class="featured-thumb"> <a href="blog_single_post.html"> <img width="80" height="53" alt="blog image" src="images/blog-img1.jpg"> </a> </figure>
                                            <!--featured-thumb-->
